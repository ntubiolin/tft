...
class InverterFormatter(GenericDataFormatter):
  ...
  _column_definition = [
      ('deviceNo', DataTypes.CATEGORICAL, InputTypes.ID),
      ('itemTimestamp', DataTypes.REAL_VALUED, InputTypes.TIME),
      ('inv_yield', DataTypes.REAL_VALUED, InputTypes.TARGET),
      ('inv_dc_link_amps_1', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('inv_dc_link_volts_1', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('inv_output_kw', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('inv_capacity', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('azimuth', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('elevation', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT),
      ('deviceNo', DataTypes.CATEGORICAL, InputTypes.STATIC_INPUT),
  ]
  ...
  def split_data(self, df, valid_boundary=1396604, test_boundary=1734941):
